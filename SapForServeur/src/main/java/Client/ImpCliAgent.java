 ...
 */
public class ImpCliAgent implements CliAgent {
	 ...
	 * @param matricule
	 */
	public ImpCliAgent(String matricule) {
	 ...
	 */
	public ImpCliAgent(String matricule, String nom) {
		this.matricule = matricule;
		this.nom = nom;
		this.prenom = new String();
	}
	 ...
	 * @param prenom
	 */
	public ImpCliAgent(String matricule, String nom, String prenom) {
		this.matricule = matricule;
		this.nom = nom;
		this.prenom = prenom;
	}
