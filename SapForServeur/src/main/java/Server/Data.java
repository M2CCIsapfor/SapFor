...
public class Data {
	...
	public Data() {
		...
		SerUV trans1 = new ImpSerUV(11, "Equipier prompt secours");
		SerUV trans2 = new ImpSerUV(12, "Moyens radio");	
		trans2.addUV(trans1);
		SerUV trans3 = new ImpSerUV(13, "Préservation du potentiel physique et psychologique");
		trans3.addUV(trans1); trans3.addUV(trans2);
		SerUV trans4 = new ImpSerUV(14, "Organisation et missions du SDIS");
		trans4.addUV(trans1); trans4.addUV(trans2); trans4.addUV(trans3);
		
		// Nouveaux UVs SECOURS A PERSONNES
		SerUV sap1 = new ImpSerUV(21, "Equipier au VSAV niv.1");
		SerUV sap2 = new ImpSerUV(22, "Equipier au VSAV niv.2");	
		sap2.addUV(sap1);
		SerUV sap3 = new ImpSerUV(23, "Equipier au VSAV niv.3");
		sap3.addUV(sap1); sap3.addUV(sap2);

		// Nouveaux UVs SECOURS ROUTIER
		SerUV sr1 = new ImpSerUV(31, "Equipier secours routier niv.1");
		SerUV sr2 = new ImpSerUV(32, "Equipier secours routier niv.2");	
		sr2.addUV(sr1);
		SerUV sr3 = new ImpSerUV(33, "Equipier secours routier niv.3");
		sr3.addUV(sr1); sr3.addUV(sr2);		
		
		// Nouveaux UVs INCENDIE
		SerUV inc1 = new ImpSerUV(41, "Protection individuelle et collective");
		SerUV inc2 = new ImpSerUV(42, "Sauvetages et mises en sécurité");	
		inc2.addUV(inc1);
		SerUV inc3 = new ImpSerUV(43, "Alimentation, établissements, extinction");
		inc3.addUV(inc1); inc3.addUV(inc2);
		SerUV inc4 = new ImpSerUV(44, "Moyens élévateurs aériens");
		inc4.addUV(inc1); inc4.addUV(inc2); inc4.addUV(inc3);		
		
		// Nouveaux UVs INTERVENTIONS
		SerUV inter1 = new ImpSerUV(51, "Interventions diverses");
		SerUV inter2 = new ImpSerUV(52, "Interventions animalières");	
		inter2.addUV(inter1);		
		...
		// Nouveaux Agents
		SerAgent mamadou = new ImpSerAgent("111", "ma");
		...
		SerSession transA = new ImpSerSession(001, trans1, "Montpellier", "11-07-2016");
		SerSession incA = new ImpSerSession(002, inc1, "Montpellier", "17-07-2016");
		SerSession srA = new ImpSerSession(003, sr1, "Montpellier", "13-07-2016");
		SerSession sapA = new ImpSerSession(004, sap1, "Montpellier", "12-07-2016");
		SerSession interA = new ImpSerSession(005, inter1, "Montpellier", "18-07-2016");
		SerStage debutants = new ImpSerStage("debutants", ibrahima);
		...
		SerSession transB = new ImpSerSession(006, trans4, "Brest", "22-06-2016");
		SerSession incB = new ImpSerSession(007, inc4, "Brest", "24-06-2016");
		SerSession srB = new ImpSerSession(010, sr3, "Brest", "28-06-2016");
		SerSession sapB = new ImpSerSession(011, sap3, "Brest", "25-06-2016");
		SerSession interB = new ImpSerSession(012, inter2, "Brest", "18-06-2016");
		SerStage experts = new ImpSerStage("experts", noel);
		...
		SerSession incC = new ImpSerSession(013, inc3, "Strasbourg", "02-05-2016");
		SerSession srC = new ImpSerSession(014, sr1, "Strasbourg", "05-05-2016");
		SerSession sapC = new ImpSerSession(015, sap2, "Strasbourg", "03-05-2016");
		SerStage intermediaires = new ImpSerStage("intermediaires", christophe);
