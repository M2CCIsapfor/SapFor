 ...
 */
public class ImpCliSession implements CliSession {
    ...
    public ImpCliSession(int id) {
        ...
        this.uv = new ImpCliUV();
    }

    public ImpCliSession(int id,CliUV uv, String date, String lieu, Integer nbMin, Integer nbMax, Integer nbFormateur) {
        this.id = id;
    	this.uv = uv;
        this.date = date;
        this.lieu = lieu;
    ...
    public ImpCliSession(int id,CliUV uv, String lieu, String date){
        this.id = id;
    	this.uv = uv;
        this.date = date;
        this.lieu = lieu;
